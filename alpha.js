			...
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === alpha.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Zenno Bot Whatsapp_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_©Zenno Bot*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/Zenno._')
}
if(isButton == 'ytm'){
reply('http://youtube.com/c/Zenno')
}
...
alpha.sendMessage(from, goo, image, {quoted: fgi, caption: 'Nih Jangan Lupa Subscribe YT : Zenno'})
break
case 'cecanrandom':
...
if (args.length == 0) return reply(`Example: ${prefix + command} RazoR`)
               ...
               sticWait(from)
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=BayuPerkasa&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        alpha.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Zenno`, quoted : fvoc})
                    })
                    break
case 'fox':  
...
case 'youtube':
teks =
`Nih Youtube Owner Ku Jangan Lupa Di Subscribe Ya https://youtube.com/Zenno`
alpha.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/Zenno`
alpha.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktod':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya TAPI BOONG GA PUNYA TIKTOD`
alpha.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'addcmd': 
case 'setcmd':
...
╔════════════════════
║ FIX BUG DizDert x Feyy x Zenno
╠════════════════════
║╭──❉ *DONASI Zenno Bot* ❉─────
║│➸ *OVO*:TIDAK TERSEDIA
║│➸ *DANA*: 085932251730
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `Zenno Bot Whatsapp`,
    "hydratedButtons": [
      {
        "urlButton": {
...
break
                ...
                anu = await fecthJson(`https://zeroyt7-api.xyz/api/tebakgambar/${body.slice(13)}?apikey=L6IsRUqK`)
                kata = anu.result
                reply(kata)
                break
				case 'resepmasakan':
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY Zenno Bot Whatsapp`)
...
if (args.length < 1) return reply('Jumlahnya?')
	    ...
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6283148634076@s.whatsapp.net" } : {}) 
	    },
                        "message": {
                        "orderMessage": {
